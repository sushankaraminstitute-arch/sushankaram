export const siteData = {
  ui: {
    videoBackground: {
      ...
      poster: "/src/assets/classroom-session.jpeg",
      overlay: "education-motion"
    },
    navigation: [
      { name: "Home", path: "/" },
    ...
    actions: {
      enroll: "https://wa.me/918894590374",
      contact: "/contact",
      courses: "/courses",
      about: "/about",
      directions: "https://www.google.com/maps/search/?api=1&query=Raja+Ka+Talab+Main+Bazzar+Fathepur+Kangra"
    },
    footerCourses: [
      { title: "NEET Coaching", path: "/courses" },
      { title: "11th & 12th Classes", path: "/courses" },
      { title: "6th to 10th Tuition", path: "/courses" },
      { title: "Patwari Exam", path: "/courses" },
      { title: "Police Exam", path: "/courses" },
      { title: "JBT & TGT", path: "/courses" }
    ]
  },
  home: {
    courses: [
